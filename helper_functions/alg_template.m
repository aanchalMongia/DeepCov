...
function Yhat=alg_grdmf_2layer(matrix,Sd,St,test_ind,~)
...
Lr;
Lc;
Yhat=grdmf_2layer(y,Sd,St,M,size(matrix),rankr, mu);
% Yhat
...
function Yhat=alg_grdmf_3layer(matrix,Sd,St,test_ind,~)

global k1 k2 k3 mu pp;
...
Lr;
Lc;
Yhat=grdmf_3layer(y,Sd,St,M,size(matrix),rankr, mu);
% Yhat
%Yhat=dgrdmf_3layer(y,M,size(matrix),[k1 k2 k3], mu1,mu2, Lr, Lc);
